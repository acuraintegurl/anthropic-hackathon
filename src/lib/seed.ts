...
export const LISTINGS: FurnitureListing[] = [
  {
    id: 'l_couch',
    postedById: 'r_amelia',
    title: '3-seater chaise sofa, off-white',
    description: 'Light fabric 3-seater with a left-side chaise. Reversible chaise, removable covers, one small mark on the seat cushion (covered when sitting). Loved it but moving into a studio — would love a neighbour to take it.',
    photoUrl: '/listings/couch.jpg',
    category: 'furniture',
    estimatedM3: 0.6,
    pickupBy: inDays(12),
    status: 'available',
  ...
  },
  {
    id: 'l_bookshelf',
    postedById: 'r_chen',
    title: 'Tall 4-cube bookshelf, warm timber',
    description: '180cm tall, warm timber finish, four open cubbies. Sturdy and all hardware intact. Moving interstate next month — would love it to stay in the building.',
    photoUrl: '/listings/bookshelf.jpg',
    category: 'furniture',
    estimatedM3: 0.3,
    pickupBy: inDays(18),
    status: 'available',
  ...
  },
  {
    ...
    description: 'Sealy Posturepedic queen. Always used with a mattress protector. Free to whoever can carry it down two flights. Frame in the photo is not included — mattress only.',
    photoUrl: '/listings/mattress.jpg',
    category: 'mattress',
    estimatedM3: 0.8,
    pickupBy: inDays(20),
    status: 'available',
  ...
  },
  {
    id: 'l_fridge',
    postedById: 'r_isla',
    title: 'Husky bar fridge, glass door',
    description: 'Husky 90L glass-door bar fridge, perfect for a studio or drinks cabinet. Working order — defrosted and cleaned. Lithium battery in the temp display has been removed.',
    photoUrl: '/listings/bar-fridge.jpg',
    category: 'whitegoods',
    estimatedM3: 0.4,
    pickupBy: inDays(15),
    status: 'available',
  ...
  },
  {
    id: 'l_chairs',
    postedById: 'r_gita',
    title: 'Round dining table + 4 chairs, charcoal',
    description: 'Round black dining table and matching set of 4 charcoal chairs. One chair has a slightly loose joint that needs a screw. Otherwise solid — the whole set goes together.',
    photoUrl: '/listings/dining-chairs.jpg',
    category: 'furniture',
    estimatedM3: 0.5,
    pickupBy: inDays(14),
    status: 'available',
